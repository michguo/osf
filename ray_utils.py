...
def create_ray_batch(
    rays_o, rays_dst, rays_i, use_viewdirs, rays_near=None, rays_far=None, epsilon=1e-10, rays_d_method="rays_o"):
    # Compute the ray directions.
    if rays_d_method == "rays_o":
        rays_d_origin = rays_o
    elif rays_d_method == "world_origin":
        rays_d_origin = torch.zeros_like(rays_o)
    else:
        raise NotImplementedError
    rays_d = rays_dst - rays_d_origin  # [R, 3]
